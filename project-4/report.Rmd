...
Using Raj's algorithm, we can calculate the diversity for the UBCF and IBCF model. 

```{r}

#user-based diversity 
getDivesity(ub_unknown, p_ub,"UBCF")

#item-based diversity 
getDivesity(ib_unknown, p_ib,"IBCF")
