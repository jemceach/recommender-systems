...
predict <- predict(svdn,ratings_test_known,type='ratings')
svd_pred <- calcPredictionAccuracy(predict,ratings_test_unknown)
predict <- predict(svdz,ratings_test_known,type='ratings')
svdz_pred <- calcPredictionAccuracy(predict,ratings_test_unknown)
predict <- as(predict(fsvd, ratings_test_known, verbose = F), "realRatingMatrix")
fsvd_pred = calcPredictionAccuracy(predict, ratings_test_unknown)
...
### ratings_train_predict <- as(tcrossprod(fsvd$U, fsvd$V),"realRatingMatrix")
