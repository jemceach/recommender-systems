...
We used the user-based collaborative filtering approach. Our data was normalized using z-score to center the data with a cosine-similarity method. 
...
We used a similiar approach for our second `recommenderlab` function. The item-based colaborative filtering approach followed the same methods as our user-based algorithm. 
